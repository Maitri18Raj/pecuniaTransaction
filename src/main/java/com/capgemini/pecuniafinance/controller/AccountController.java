...
public class AccountController {
	...
	public String creditUsingSlip(@RequestBody Transactions transaction) throws AccountIdNotFound{
	...
	try {
		...
		System.out.println(msg);
			...
			throw new AccountIdNotFound("Details Incorrect.Please try again");
	} 
	catch (Exception e) {
	...
	public String debitUsingSlip(@RequestBody Transactions transaction) throws AccountIdNotFound{
	...
	public String creditUsingCheque(@RequestBody Transactions transaction) throws AccountIdNotFound{
		logger.trace("Credit is done using slip");
		String msg=null;
	try {
	...
	public String debitUsingCheque(@RequestBody Transactions transaction) throws AccountIdNotFound{
